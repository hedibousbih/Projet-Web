...
/*$event1core=new eventcore();
$listeevent=$event1core->fetch_events();
    if (isset($_GET['idmod']) and isset($_GET['Etat']))
    $event1core->modifierEtat($_GET['Etat'],$_GET['idmod']);



    if(isset($_POST['Rechercher']))
    $listeevent=$event1core->afficherevent($_POST['Rechercher']) ;



    if (isset($_POST['tri'])) {
        $listeevent = $event1core->tridate();
        }*/
...
<?php
 foreach ($listeevent as $event){ ?>
                <div class="col-12 tm-block-col">
                    ...
                    <div>
                        <h2 class="tm-block-title">event Msr/Mme de l'id : <?php  echo $event['Id_event']?></h2>
                        <h2 class="tm-block-title">Etat event <?php  echo $event['Etat']?></h2>
                        <div>
                            <form class="searchtri" method="post" action="index.php">
                                <div>
                                <input name ="Rechercher" type="text" placeholder="Rechercher id event..">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                            <?php
                            $cartRows=$event1core->geteventRows($event['id_event']);
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a style="color:gold" href="index.php?idmod=<?php echo $event['Id_event'];?>&Etat=1">
                                        livrée </a>
                                    </td>
                                    <td>
                                        ...
                                        <button><i class="far fa-trash-alt tm-product-delete-icon" aria-hidden="true">
