...
if (
  ...
  if (
    ...
    $classesC->ajouterclasse($classes);
    $classesC->createclasse($classes->getnomclass());
...
<head>
  ...
  <link rel="stylesheet" href="../ClassCreation.css" media="screen">
  ...
  <meta property="og:title" content="ClassCreation">
  <meta property="og:type" content="website">
  <script src="../ControlClassCreation.js"></script>
</head>
...
<body class="u-body">
  ...
  <section class="u-align-center u-clearfix u-gradient u-section-1" id="carousel_91ba">
    <div class="u-clearfix u-sheet u-sheet-1">
      <h2 class="u-text u-text-1">Create a classe</h2>
      <div class="u-form u-form-1">
        <form method="POST" class="u-clearfix u-form-spacing-0 u-form-vertical u-inner-form" style="padding: 0px;" name="pcc">
          <div class="u-form-email u-form-group u-form-group-1">
            ...
            <input type="text" placeholder="ex(Talos 1,...)" id="nomclass" onfocusout="verifnomclass()" name="nomclass" class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-courier-new u-input u-input-rectangle" autofocus="autofocus">
          </div>
          <div class="u-form-group u-form-name u-form-group-2">
            <label for="name-f2a8" class="u-custom-font u-font-courier-new u-label u-label-2">Level</label>
            <input type="text" placeholder="Avancé" id="niveau" onfocusout="verifniveau()" name="niveau" class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-courier-new u-input u-input-rectangle">
          </div>
          <div class="u-form-group u-form-name u-form-group-2">
            <label for="name-f2a8" class="u-custom-font u-font-courier-new u-label u-label-2">idprof</label>
            <input type="text" placeholder="idprof" id="idprof" name="idprof" onfocusout="verifidprof()" class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-courier-new u-input u-input-rectangle">
          </div>
          <div class="u-form-group u-form-select u-form-group-3">
            <label for="select-8e9d" class="u-custom-font u-font-courier-new u-label u-label-3">Matiére</label>
            <div class="u-form-select-wrapper">
              <select id="matiere" name="matiere" onfocusout="verifmatiere()" class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-courier-new u-input u-input-rectangle">
          ...
          <div class="u-form-date u-form-group u-form-group-4">
            ...
            <input type="date" placeholder="MM/DD/YYYY " id="datedebut" onfocusout="verifdatedebut()" name="datedebut" class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-courier-new u-input u-input-rectangle">
          </div>
          <div class="u-form-group u-form-group-5">
            <label for="message-f2a8" class="u-custom-font u-font-courier-new u-label u-label-5">Duree</label>
            <input placeholder="How long you course will be?(hours)" onfocusout="verifduree()" rows="4" cols="50" id="duree" name="duree" class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-courier-new u-input u-input-rectangle" type="text">
          </div>
          <div class="u-align-center u-form-group u-form-submit u-form-group-6">
            <input type="submit" value="Add class" class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-gradient u-hover-palette-1-dark-1u-radius-14 u-btn-1">
          </div>
          <div id="error">
            <?php echo $error; ?>
          </div>
