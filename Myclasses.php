...
$listeclasses = $classesC->afficher1classes();
?>
<!DOCTYPE html>
          ...
          <tbody class="u-align-center u-custom-font u-font-courier-new u-table-body">
            ...
            ?>
                <tr style="height: 75px;">
                  ...
                  <td class="u-border-1 u-border-grey-30 u-table-cell"><a href="supprimerclasses.php?idprof=<?php echo $classes['idclass']; ?>">Supprimer</a></td>
                  <td class="u-border-1 u-border-grey-30 u-table-cell"><a href="../mailer/index.php?nomclass=<?php echo $classes['nomclass']; ?>
                  &niveau=<?php echo $classes['niveau']; ?>
                  &matiere=<?php echo $classes['matiere']; ?>
                  &datedebut=<?php echo $classes['datedebut'];?> 
                  &duree=<?php echo $classes['duree']; ?>
                  "> Send </a></td>
                </tr>


              <?php
              } else if ($classes['etat'] == 1) {
              ?>
                <tr style="height: 75px;">
                  <td class="u-border-1 u-border-grey-30 u-table-cell"> <?php echo $classes['nomclass']; ?></td>
                  <td class="u-border-1 u-border-grey-30 u-table-cell"> this class is blocked</td>
                  <td class="u-border-1 u-border-grey-30 u-table-cell"> this class is blocked</td>
                  <td class="u-border-1 u-border-grey-30 u-table-cell"> this class is blocked</td>
                  <td class="u-border-1 u-border-grey-30 u-table-cell"> this class is blocked</td>
                  <td class="u-border-1 u-border-grey-30 u-table-cell"> this class is blocked</td>
