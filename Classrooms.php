...
<head>
  ...
  <meta charset="utf-8">
  <meta name="keywords" content="Classrooms Available">
  <meta name="description" content="">
  <meta name="page_type" content="np-template-header-footer-from-plugin">
  <title>Classrooms</title>
  <link rel="stylesheet" href="../nicepage.css" media="screen">
  <link rel="stylesheet" href="../Classrooms.css" media="screen">
...
<body class="u-body">
      ...
      <nav class=" u-menu-dropdown u-offcanvas u-menu-1" data-responsive-from="XS" data-position="">
        <div class="menu-collapse u-custom-font u-font-courier-new" style="font-size: 1rem; letter-spacing: 0px; text-transform: uppercase;">
          <a class="u-button-style u-custom-active-color u-custom-border u-custom-border-color u-custom-border-radius u-custom-color u-custom-hover-color u-custom-left-right-menu-spacing u-custom-padding-bottom u-custom-text-active-color u-custom-text-color u-custom-text-hover-color u-custom-top-bottom-menu-spacing u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="#" style="color: rgb(17, 17, 17) !important;">
            <svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 612 612" <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-77e1"></use></svg>
  ...
  <section class="u-align-center u-clearfix u-gradient u-section-1" id="carousel_8409">
    <div class="u-clearfix u-sheet u-sheet-1">
      <h1 class="u-custom-font u-font-raleway u-text u-text-1">Classrooms Available</h1>
      <p class="u-text u-text-2">Here you can access to all classrooms.</p>
              ...
              <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1">
                <div class="u-align-center u-container-style u-expanded-width u-group u-palette-5-dark-2 u-group-1">
                  <div class="u-container-layout u-valign-middle u-container-layout-2">
                    <h3 class="u-custom-font u-font-raleway u-text u-text-3"><?php echo $classes['idprof']; ?></h3>
                  </div>
                </div>
                <img alt="" class="u-expanded-width u-image u-image-default u-image-1" src="../pics/Classroom_cover.jfif" data-image-width="1920" data-image-height="1080">
                <div class="u-container-style u-expanded-width u-group u-group-2">
                  <div class="u-container-layout u-valign-top u-container-layout-3">
                    <p class="u-align-center u-text u-text-4"><?php echo $classes['matiere']?></p>
                    <ul class="u-align-left u-custom-list u-text u-text-5">
                      <li>
                        <div class="class u-list-icon">
                          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xml:space="preserve" class="u-svg-content" viewBox="0 0 512.019 512.019" x="0px" y="0px" id="svg-b379">
                            <path fill="currentColor" d="M362.676,0H149.343C119.888,0,96.01,23.878,96.01,53.333v448 c-0.011,5.891,4.757,10.675,10.648,10.686c2.84,0.005,5.565-1.123,7.571-3.134L256.01,367.083l141.781,141.781 c4.16,4.171,10.914,4.179,15.085,0.019c2.006-2.001,3.133-4.717,3.134-7.55v-448C416.01,23.878,392.131,0,362.676,0z"></path>
                          </svg>
                        </div><?php echo $classes['niveau']; ?>
                      </li>
                      <li>
                        <div class="class u-list-icon">
                          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xml:space="preserve" class="u-svg-content" viewBox="0 0 512.019 512.019" x="0px" y="0px" id="svg-b379">
                        ...
                        </div><?php echo $classes['datedebut']; ?>
                      </li>
                      <li>
                        <div class="class u-list-icon">
                          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xml:space="preserve" class="u-svg-content" viewBox="0 0 512.019 512.019" x="0px" y="0px" id="svg-b379">
                      ...
                      <li>
                        ...
                        </div><?php echo $classes['nomclass']; ?>
                      </li>
                    </ul>
                    <a href="
                    addtoclass.php?idclass=<?php echo $classes['idclass'];?>&iduser=<?php echo $_SESSION["iduser"]?>
                    " 
                    class="u-btn u-btn-rectangle u-button-style u-palette-4-base u-btn-1">Integrer a cette classes</a>
                  </div>
                </div>
              </div>
            </div>
  ...
  <footer class="u-clearfix u-footer u-grey-80" id="sec-623b">
    <div class="u-clearfix u-sheet u-sheet-1">
      ...
      <div class="u-align-left u-social-icons u-spacing-10 u-social-icons-1">
        <a class="u-social-url" title="facebook" target="_blank" href=""><span class="u-icon u-social-facebook u-social-icon u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-3e42"></use></svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-3e42">
              <circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
              <path fill="#FFFFFF" d="M73.5,31.6h-9.1c-1.4,0-3.6,0.8-3.6,3.9v8.5h12.6L72,58.3H60.8v40.8H43.9V58.3h-8V43.9h8v-9.2
            c0-6.7,3.1-17,17-17h12.5v13.9H73.5z"></path>
            </svg></span>
        </a>
        <a class="u-social-url" title="twitter" target="_blank" href=""><span class="u-icon u-social-icon u-social-twitter u-icon-2"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-7c73"></use></svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-7c73">
        ...
        <a class="u-social-url" title="instagram" target="_blank" href=""><span class="u-icon u-social-icon u-social-instagram u-icon-3"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-28c3"></use></svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-28c3">
              <circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
        ...
        <a class="u-social-url" title="linkedin" target="_blank" href=""><span class="u-icon u-social-icon u-social-linkedin u-icon-4"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-5557"></use></svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-5557">
              <circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
