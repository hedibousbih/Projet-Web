...
$listeclasses = $classesC->affichermyclasses();
session_start();
$_SESSION["iduser"] = 1;
        ...
        <table class="u-table-entity u-table-entity-1">
          ...
          <thead class="u-black u-custom-font u-font-courier-new u-table-header u-table-header-1">
            <tr style="height: 21px;">
              ...
              <th class="u-grey-40 u-table-cell u-table-cell-7">Quit</th>
            </tr>
          </thead>
          <tbody class="u-align-center u-custom-font u-font-courier-new u-table-body">
            ...
            ?>
              <tr style="height: 75px;">
                ...
                <td class="u-border-1 u-border-grey-30 u-table-cell"><a href="quitterclasses.php?idclass=<?php echo $classes['idclass']; ?>">Leave</a></td>
